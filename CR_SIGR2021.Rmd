...
[Lien vers le code de la présentation au format R Markdown](https://github.com/sigr2021/markdown/blob/main/index.Rmd)
...
[Lien vers le code de la présentation au format R Markdown](https://github.com/sigr2021/xaringan/blob/main/index.Rmd)
...
[Lien vers le code de la présentation au format R Markdown](https://github.com/sigr2021/git/blob/master/index.Rmd)
...
L'objectif de l'atelier est de créer un compte github, configurer git sur sa machine avec une clé SSH pour s'authentifier, créer un dépôt = projet avec une présentation rmarkdown, et mettre en ligne cette présentation. Voir la présentation pour le pas à pas détaillé.
...
[Lien vers le code de la présentation au format R Markdown](https://github.com/Nowosad/SIGR2021/blob/master/lecture/lecture.Rmd)
...
[Lien vers la partie 1 au format HTML](https://nowosad.github.io/SIGR2021/workshop1/workshop1_rl.html)

[Lien vers la partie 1 au format R Markdown](https://github.com/Nowosad/SIGR2021/tree/master/workshop1)

[Lien vers la partie 2 au format HTML](https://nowosad.github.io/SIGR2021/workshop1/workshop1_jn.html)

[Lien vers la partie 2 au format R Markdown](https://github.com/Nowosad/SIGR2021/tree/master/workshop2)
...
[Lien vers le code de la présentation au format R Markdown](https://sigr2021.github.io/gwr/)
...
[Lien vers la présentation au format HTML](https://mmadelin.github.io/sigr2021/SIGR2021_raster_MM.html#1)

[Lien vers le dépôt gihub de la présentation](https://github.com/mmadelin/sigr2021)
...
### Faire des cartes avec le package R mapsf<a name="off_giraud_jeudi"></a>

### Image processing and all things raster<a name="atelier_nowosad_vendredi"></a>
...
[Projet Rzine(https://rzine.fr/)] : partage de ressouurces autour de R dans les SHS
