...
zion_extract = terra::extract(srtm_utm, vect(zion_points))
head(zion_extract)
```
...
Segmentation d'images avec le package [supercells](https://github.com/Nowosad/supercells) en cours de développement par Jakub. Ce package permet de faire de la classif obket pour des images RGB, des rasters catégorisés ou continus.
